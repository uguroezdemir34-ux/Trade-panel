...
export const ru: Dictionary = {
  ...
  karar: {
    ...
    trendStrong: "сильное выравнивание EMA",
    trendMedium: "среднее выравнивание EMA",
    trendWeak: "слабое выравнивание EMA",
    ...
    shortcutSelectPair: "Выбрать пару (BTC=1, ETH=2, SOL=3, BNB=4, LINK=5, AVAX=6, NEAR=7, SUI=8)",
...
volumeSection: "ОБЪЁМ",
    ...
    holdExitWaitNoSignal: "Ждать / Нет чёткого сигнала",
