...
toolCursor: "Курсор",
  ...
  copyTrading: {
    ...
    profileTitle: "Профиль трейдера",
    profileActiveSince: "Активен с",
    profileTrades: "Сделки",
    profileNoTrades: "Пока нет закрытых сделок — профиль заполнится по мере торговли.",
  },
