...
function buildCsp(nonce: string): string {
  return [
    ...
    `img-src 'self' data: blob: https://s2.coinmarketcap.com https://cdn.jsdelivr.net https://img.clerk.com`,
    `connect-src 'self' https://api.clerk.com https://*.clerk.accounts.dev https://clerk-telemetry.com wss://ws.okx.com wss://wsaws.okx.com wss://wsap.okx.com wss://stream.binance.com wss://fstream.binance.com wss://fstream1.binance.com wss://stream.bybit.com wss://stream.bytick.com`,
